    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.JSONField(blank=True, default=dcApp.models.json_hours, null=True)),
                ('lon', models.FloatField(blank=True, null=True)),
                ('lat', models.FloatField(blank=True, null=True)),
                ('can_donate', taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of tags.', related_name='donate_centers', through='dcApp.ThroughDonateTag', to='taggit.Tag', verbose_name='Tags')),
                ('can_find', taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of tags.', related_name='find_centers', through='dcApp.ThroughFindTag', to='taggit.Tag', verbose_name='Tags')),
            ],
        ),
    ]
